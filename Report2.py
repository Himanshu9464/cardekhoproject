...
class carReport2page:
    def __init__(self,hp_window):
        ...
        self.headlbl =Label(self.window,text="Sold Report",background=mycolor2,font=("Cambria",35),
