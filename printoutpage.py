...
if __name__ == '__main__':
    pdf = my_cust_PDF()
    data=[['CName','Phone No','Gender','DOB','Address','Aadhaar ID','Brand','Category','Car Name','Registeration','Manufacturing','Fuel Type','Price'],
          ['CName', 'Phone No', 'Gender', 'DOB', 'Address', 'Aadhaar ID', 'Brand', 'Category', 'Car Name','Registeration', 'Manufacturing', 'Fuel Type', 'Price'],
        ['CName', 'Phone No', 'Gender', 'DOB', 'Address', 'Aadhaar ID', 'Brand', 'Category', 'Car Name', 'Registeration', 'Manufacturing', 'Fuel Type', 'Price']]
    ...
    pdf.print_chapter(data,headings,13)
